...
"""shannon_entropy - method to calculate the shannon entropy from a deep sequencing dataset"""

from sys import version_info

#Setup our protocol name
str_protocol_name = "Shannon Entropy"
...
class shannon_entropy:
    """Calculate the Shannon entropy of enrichment values"""
    ...
    def __init__(self, file_config, dict_programs, preamble):
        ...
        try:
            ...
            print("[Protocols:Shannon Entropy Error] The config file is incorrect.")
            print("[Protocols:Shannon Entropy Error] There is something wrong with the [workflow] section.")
            quit()
        except ValueError:
            print("[Protocols:Shannon Entropy Error] The config file is incorrect.")
            print("[Protocols:Shannon Entropy Error] There is something wrong with the [workflow] section (spelling???).")
            quit()
        ...
        with open(self.directory + self.output_prefix + "_" + strftime("%m_%d_%Y") + "-" +
            ...
            *****************************************
            ...
            if not self.obj_cfgparser.has_section('combinepact'):           
                print("[Protocols:Shannon Entropy Error] The combinepact config file is incorrect.")
                print("[Protocols:Shannon Entropy Error] There is something wrong with the [combinepact] section.")
                quit()
            ...
            try:
                ...
                print("[Protocols:Shannon Entropy Error] combine_pact was not found.")
            ...
            *****************************************
            ...
            try:
                ...
                print("[Protocols:Shannon Entropy Error] Cannot load pact.analysis.sequence.shannon_entropy")
                quit()

            #Create our object
            obj_se = shannon_entropy_classifier(self.obj_cfgparser, self.dict_programs, {'directory':self.directory})
